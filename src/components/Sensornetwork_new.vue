    ...
    <div class="main">
      ...
      <div class="first">
        ...
        <div class="query24" style="width: 100%;height: 50px;padding-top: 49px;padding-left: 10px">
          <!---->
          <div class="shijian">
            <!--时间选择--> <span style="font-size: 15px;font-weight: bold;padding-right: 10px;color: #12DA88">监测点分类</span>

            <el-select v-model="KeyDvalue" size="small" placeholder="请选择">
      ...
      <div class="table_container">
        <el-table :data="tableData" border stripe :row-class-name="tableRowClassName" @current-change="RowCurrentChange"
                  style="width:100%">
    ...
    methods: {
      ...
      SetDataList(data, type) {
        ...
        dt2.forEach(item => {
          ...
          tableData.aqi = item['pm25'.toLowerCase()];//数值
