      ...
      <el-tabs v-model="TitleName" @tab-click="handleClick">
        ...
        <div class="kass" v-if="false">
          <div class="wbiaoti">
            ...
            <div class="ExportBtn" v-show="StatisticalRankingsName=='自定义'?true:false">
              <el-button v-show="$store.state.responsibility===false" type="primary" @click='isExport=true'>导出
              </el-button>
            </div>
          </div>
        </div>
        ...
        <div class="chaxuntiaojian">
          ...
          <div class="float003">
            ...
            <el-button v-show="StatisticalRankingsName=='自定义'?true:false" type="primary" @click='isExport=true'>导出
            </el-button>
          </div>
        </div>
        <!---->
