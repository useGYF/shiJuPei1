          ...
          <div class="neirong">
            ...
            <div class="lie_teble">
              <table id="testTable1" border="0" borderColor="#fff" width="500">
                <tr style="background: #161C3A;color: #fff;">
                ...
                <tr v-for="item in alldatalist">
                  <td bgcolor="#161C3A" style="height: 40px;color: #fff;"><span class="t_items">{{item.mtime}}点</span> </td>
                ...
                <tr>
                  <td bgcolor="#161C3A" style="height: 40px;color: #fff;"><span class="t_items">均值</span></td>
