      ...
      <el-tabs v-model="TitleName" @tab-click="handleClick">
        <div class="chaxuntiaojian">
          ...
          <div class="float003">
            ...
            <el-button type="primary" @click='isExport=true'>导出</el-button>
          </div>
        </div>
        <!---->
        <div class="kass">
...
//                  }
    ...
    methods: {
      ...
      GetDustRank() {
        ...
        api.GetDustRank(ranktype, starttime, endtime,PageIndex,PageSize).then(res => {
          console.log(res)
          let t = this;
          let stateData = [];
          if (res.data.Status >0) {
            stateData = res.data.Data.Data;
            t.statePageData = [];
